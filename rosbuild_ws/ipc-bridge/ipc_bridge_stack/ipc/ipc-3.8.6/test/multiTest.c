...
#else
#include <stdlib.h>
#define SAMPLE_FORMAT "{int, <char:1>, double}"
#define BIG_STRING (10000000)
#endif
...
#ifdef MULTI2
  query1.i1 = BIG_STRING;
  query1.str1 = malloc(query1.i1);
#endif
  int count = 0;
...
#ifdef MULTI2
    sprintf(query1.str1, "query1 %d", count);
#endif
...
#ifdef MULTI2
  query2.i1 = BIG_STRING;
  query2.str1 = malloc(query2.i1);
#endif
  int count = 0;
...
#ifdef MULTI2
    sprintf(query2.str1, "query2 %d", count);
#endif
